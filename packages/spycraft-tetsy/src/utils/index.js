...
const isAddressValid = h => spycraft.Spook.instanceOf(h) ? h.map(ParityApi.util.isAddressValid) : ParityApi.util.isAddressValid(h);
const toChecksumAddress = h => spycraft.Spook.instanceOf(h) ? h.map(ParityApi.util.toChecksumAddress) : ParityApi.util.toChecksumAddress(h);
const sha3 = h => spycraft.Spook.instanceOf(h) ? h.map(ParityApi.util.sha3) : ParityApi.util.sha3(h);
