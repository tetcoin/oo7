...
const { post, composeTransaction, TransactionSpook } = require('./transact')
...
const { storageKey, StorageSpook } = require('./storageSpook')
const { initRuntime, runtime, calls, runtimePromise, callsPromise, chain, system, state, runtimeUp } = require('./spooks')
...
if (typeof window !== 'undefined') {
	...
	window.storageKey = storageKey
	window.StorageSpook = StorageSpook
	window.TransactionSpook = TransactionSpook
	window.lookup = query => {
